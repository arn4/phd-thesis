...
enormous computational and energy costs of training.
...
The settings we analyze remain idealizations, and closing the gap to real-world
systems is the longer goal; here we take one small, deliberate step toward it.
