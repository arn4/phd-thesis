...
\end{align}
now corresponds to initializing close to the saddle point $m^{0}=0$: with high-probability the initial weights are orthogonal to the signal at high-dimensions: 
\begin{align}
