...
\end{itemize}
Therefore, the landscape now resembles a golf course: completely flat with a single whole corresponding with the global minimum $w_{\star}$, see Fig.~\ref{2305:fig:app:landscape} for an illustration. This is the prototypical image of mediocrity. In particular, differently from the unconstrained case, random initialization
\begin{align}
