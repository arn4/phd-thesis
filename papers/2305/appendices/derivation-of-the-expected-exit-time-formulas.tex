...
\end{split}\]
This formula can be used to estimate the overparameterization gain. Noting that \(s^\text{min}_\text{ext}\) is monotonically decrising in \(p\), we can define the gain as
\[
