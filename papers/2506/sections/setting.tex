...
\begin{assumption}[Gradient flow approximation]
    We approximate the training dynamics of eq.\eqref{2506:eq:normalized-SGD-w} via the following ODE, which corresponds to an order-2 Taylor expansion in $\gamma$:
