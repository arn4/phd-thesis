...
\begin{split}
    \vec{w}^{\nu+1} &= \frac{\vec{w}^\nu - \gamma \nabla_{\vec{w}} \ell(X^\nu, \vec{y}^\nu; f_{\vec{w}})}{\left\lVert \vec{w}^\nu - \gamma \nabla_{\vec{w}} \ell(X^\nu, \vec{y}^\nu; f_{\vec{w}})\right\rVert}
    \norm{\vec{w}^\nu}.
