...
\begin{figure}
    ...
    \caption{Population loss landscape for \(P=0\) (left) and \(P\neq 0\) (right). Example of a case where \({\rm SIE}=4\), while \({\rm SIE}_\mathrm{positional}=2\). Target: \(g(\vec{z}_\star) = \sfrac43 + \mathrm{He}_4(z_1) + 2\mathrm{He}_4(z_{\star,2})\), \(P_1=-P_2\), \(\Pi = \Tr\).
    }
