...
The sequential information exponent of this setting is \(\mathrm{SIE}=2\) (see Appendix~\ref{2506:app:further-positional-demantic} for the explicit derivation), thus by Theorem~\ref{2506:thm:sie} the sample complexity for escaping the initialization is \(\mathcal{O}(d \log^2 d)\).
