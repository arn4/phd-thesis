...
\begin{itemize}
    ...
    \item when $\sie \geq 2$,
    \[ m(t) \geq \left(m(0)^{2-\sie} - \frac{C_{\sie} \times (\ind_L, \dots, \ind_L)}{2}t^{\sie-2}\right)^{-\frac1{\sie-2}},\] hence\[\tau_\eta \leq \frac{C'd^{\frac\sie2-1}}{C_{\sie} \times (\ind_L, \dots, \ind_L)}. \]
\end{itemize}
