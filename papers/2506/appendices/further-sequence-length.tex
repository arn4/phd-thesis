...
\begin{equation} \label{2506:eq:app:gain-breakdown}
  \mathrm{gain} \sim \left(\text{gain at constant } \gamma\right) \cdot \left(\frac{\gamma_\mathrm{tied}}{\gamma_\mathrm{untied}}\right)\cdot \left(\text{special factor for SIE}=1\right)
\end{equation}
...
\begin{equation}
    \gamma_\mathrm{tied} = \gamma_\mathrm{untied} = \text{constant with } L =  \gamma_0.
\end{equation}
