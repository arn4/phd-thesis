...
This speedup comes from the different structure of the two networks, the tied one can build up correlation faster than the untied one because it composes \(L\) different signals. The strength of this effect is strongly dependent on the target function, the overall result is
\begin{equation}
...
In Appendix~\ref{2506:app:proofs}, we showed that the learning rate can grow with the sequence length \(L\) at most as
\begin{itemize}
