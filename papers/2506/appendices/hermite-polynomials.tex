\section{Mathematical preliminaries and notations}\label{app:hermite-polynomials}
...
\begin{theorem}
    ...
    \begin{equation}\label{eq:app:hermite_expansion}
...
\end{theorem}
The proof of this theorem can be found in \cite{grad1949note}. The identity \eqref{eq:app:hermite_expansion} is called the \emph{Hermite expansion} of $f$, and the $C_k(f)$ are its \emph{Hermite coefficients}. 
...
% \begin{equation}\label{eq:hermite_coeff_derivative}
