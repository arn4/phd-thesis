...
\begin{split}
    ...
    \Phi_{jl}(\Omega) =&  \mathbf{1}_{\{\delta\ge0 \bigcap 2\delta+\mu\ge1\}}\frac{\gamma_0}{p}\left(a_j\phi^{\rm{GF}}_{jl}+a_l\phi^{\rm{GF}}_{lj}\right) \\
        &+\mathbf{1}_{\{\delta+\mu\ge1 \bigcap 2\delta+\mu\le1\}}\frac{\gamma_0^2}{p^2n_0}a_j a_l \phi^{\rm{HD}}_{jl}
        % \\
...
\label{2406:eq:main:time_horizon}
    \mathbb{E} \norm{\Omega_t - \bar \Omega(t\Delta \tau)} \le e^{C\tau}\sqrt{\Delta \tau}
\end{equation}
with
    $\tau = t\Delta\tau$ and $\Delta \tau = d^{\max(-\delta,-2\delta+1-\mu)}$.
\end{proposition}
