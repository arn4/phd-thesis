...
\begin{proof}
    ...
    \[ \langle \vec{g}_t^\bot, \vec{w}_t^\star \rangle^2 = (\langle \vec{w}^\star, \Et{\vec{g}_t^\bot} \rangle + Z_t)^2 \leq 2(\langle \vec{w}^\star, \Et{\vec{g}_t^\bot} \rangle^2 + Z_t^2) \leq \phi(m_t)^2(1 - m_t^2)^2 + O\left(\frac{d}{n_b}\right).\] 
\end{proof}
