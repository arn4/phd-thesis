...
We thus train various models to explore the effect of each training phase: unsupervised contrastive, supervised contrastive, and knowledge distillation. All the different settings are illustrated in Figure~\ref{fig:pipelines}.
...
\begin{figure}[t]
  \centering
  \resizebox{\textwidth}{!}{\input{figs/pipelines_figure}}
...
\caption{
  ...
  The query and document lengths include the tokens of the prompts (see Section~\ref{sec:prompts}).
