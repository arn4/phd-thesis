...
\begin{theorem}[Informal]
    There is a choice of hyperparameters such that if $h^\star$ is a polynomial function, Algorithm~\ref{2405:algo:optimizer_main_step} achieves weak recovery in $O(d\log(d)^2)$ samples.
\end{theorem}
...
\begin{itemize}
    ...
    \item We unveil that the dynamics of the family of Alg.~\ref{2405:algo:optimizer_main_step} are governed by the generative exponent \cite{damian2024computational}, with an additional polynomial restriction on the transformation of the output.
