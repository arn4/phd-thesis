...
In~\Cref{2605:fig:celeba-feature-importance} each panel shows $\bar{I}^{(\ell)}$ reshaped to the $64\times64$ image grid and averaged over the three colour channels. We min--max rescale each panel independently to $[0,1]$. 
